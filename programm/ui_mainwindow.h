...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBoxControl->setGeometry(QRect(10, 380, 314, 51));
        ...
        pushButtonRotate = new QPushButton(groupBoxControl);
        pushButtonRotate->setObjectName(QStringLiteral("pushButtonRotate"));
        pushButtonRotate->setGeometry(QRect(227, 20, 75, 23));
        ...
        menuFile->addAction(actionRotate);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonRotate->setText(QApplication::translate("MainWindow", "Rotate", 0));
